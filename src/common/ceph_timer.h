...
namespace ceph {
  ...
  namespace timer_detail {
    ...
    // Compared to the SafeTimer this time does less allocation (you
    // don't have to reallocate a whole note Context every time you
    // wan to cue yourself up for the next tick.
    //
    ...
    //
    // You get to pick your clock. I like mono_clock generally, since
    // usually want to wait FOR a given duration. real_clock is
    // worthwhile if you want to wait FOR a specific moment of
    // wallclock time. But if you want you can set up a timer that
    // executes a function after you use up ten seconds of CPU time.
