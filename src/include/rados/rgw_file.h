...
/*
  create a new file
*/
  int rgw_create_file(const struct rgw_file_handle *parent_handle, const char* name);

  int rgw_rename(const struct rgw_file_handle *parent_handle, const char* old_name,
		 const char* new_name);
